...
import {latestNews,articleNews,gallertNews} from '../actions/actionfile';
...
class Home extends Component{
  componentDidMount(){
    ...
    this.props.dispatch(gallertNews())
  ...
  render(){
    return(
      ...
      <GalleryDisplay gdata={this.props.gallerylist.gallertNews}/>
      </div>
    )
  }
}
